...
class MatchErrorRate(BaseMetric):
    """Match Error Rate metric for ASR evaluation.

    This class implements the Match Error Rate (MER) metric, which measures the accuracy
    ...
    def __init__(self, name: str = "MER") -> None:
        """Initialize the MatchErrorRate metric.

        Parameters
        ----------
        name : str, optional
            Name of the metric, by default "MER"
